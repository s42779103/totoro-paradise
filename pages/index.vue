...
const checkScanStatus = async () => {
  ...
  try {
    ...
    if (code) {
      ...
      console.log('[Login] 步骤1: 获取 token 成功')

      console.log('[Login] 步骤2: 登录获取个人信息...')
      ...
      console.log('[Login] 步骤2: 登录成功, stuNumber:', personalInfo.stuNumber, 'name:', personalInfo.stuName)
      ...
      console.log('[Login] 步骤3: 会话预热完成, 跳转 /scanned')
